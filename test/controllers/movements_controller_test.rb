...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { current_cue: @movement.current_cue, name: @movement.name, notes: @movement.notes, progression_rule: @movement.progression_rule } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { current_cue: @movement.current_cue, name: @movement.name, notes: @movement.notes, progression_rule: @movement.progression_rule } }
